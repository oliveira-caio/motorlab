...
def get(keypoints_type: str) -> dict:
    """
    ...
    ----------
    keypoints_type : str
        Options: reduced, normal, extended.
    ...
    """
    return KEYPOINTS[keypoints_type]
...
def get_skeleton(skeleton_type: str) -> list:
    """
...
def get_neckless_skeleton(skeleton_type: str) -> list:
    """
